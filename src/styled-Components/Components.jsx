...
export const ContenedorCardAboutUs=styled.div`
  ${tw`
    hidden md:flex flex-col h-auto w-[40%] items-center md:px-10 pt-5 pb-6 md:pb-10 bg-gray-700 cursor-pointer border border-gray-500 
  `}
`;
...
export const ContenedorCard = styled.div`
  ${tw`
    flex flex-col h-full bg-white opacity-70 border border-gray-900 rounded-[20px] items-center pt-[25px] pb-[25px] transition-transform duration-300 ease-out cursor-pointer hover:text-[#000000] w-[95%] md:w-full mx-auto md:mx-0
  `}
  &:hover {
...
export const ContenedorTiempoActual = styled.div`
  ${tw`
    flex w-[80%] mx-2 pt-[20px] md:pt-[200px] flex-col border border-gray-500 border-solid rounded-[30px] shadow-md transition-transform duration-300 ease-out text-white bg-[#00054642] sm:p-[5px] md:w-[25%] md:pt-[20px] lg:pt-[40px] lg:pb-[60px]
  `}
...
export const Boton=styled.button`
  ${tw`
    flex mt-3 my-1 py-2 md:py-3 md:my-3 font-medium rounded-lg text-lg md:text-xl w-auto px-10 text-white bg-blue-700  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800
  `}
`;
